...
var map = {
	"./Bad_Touch.png": 10,
	"./Beer.png": 146,
	"./Bleeding_Jane.png": 121,
	"./Bloom_Light.png": 756,
	"./Blue_Fairy.png": 282,
	"./Brandtini.png": 939,
	"./Cobalt_Velvet.png": 461,
	"./Crevice_Spike.png": 228,
	"./Fluffy_Dream.png": 486,
	"./Fringe_Weaver.png": 426,
	"./Grizzly_Temple.png": 220,
	"./Gut_Punch.png": 744,
	"./Marsblast.png": 77,
	"./Mercuryblast.png": 218,
	"./Moonblast.png": 838,
	"./Piano_Man.png": 122,
	"./Piano_Woman.png": 19,
	"./Pile_Driver.png": 35,
	"./Sparkle_Star.png": 965,
	"./Sugar_Rush.png": 477,
	"./Sunshine_Cloud.png": 290,
	"./Suplex.png": 505,
	"./Zen_Star.png": 206
};
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "B": () => (/* binding */ MENU_TRANSITION_SEC)
/* harmony export */ });
const MENU_TRANSITION_SEC = 1.5;
...
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(984);
/* harmony import */ var _homepageView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(250);
/* harmony import */ var _menuView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(607);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_homepageView__WEBPACK_IMPORTED_MODULE_1__]);
_homepageView__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
function controlHomepage() {
  _model__WEBPACK_IMPORTED_MODULE_0__/* .setCurrentCategory */ .wn();
  _model__WEBPACK_IMPORTED_MODULE_0__/* .setCurrentSubcategory */ .dO();

  _homepageView__WEBPACK_IMPORTED_MODULE_1__/* ["default"].render */ .Z.render(_model__WEBPACK_IMPORTED_MODULE_0__/* .state.staff */ .SB.staff);
  _homepageView__WEBPACK_IMPORTED_MODULE_1__/* ["default"].addHandlerToggleEntrance */ .Z.addHandlerToggleEntrance();
}

function controlMenu(category, subcategory) {
  if (category) _model__WEBPACK_IMPORTED_MODULE_0__/* .setCurrentCategory */ .wn(category);
  if (subcategory) _model__WEBPACK_IMPORTED_MODULE_0__/* .setCurrentSubcategory */ .dO(subcategory);

  _menuView__WEBPACK_IMPORTED_MODULE_2__/* ["default"].render */ .Z.render(_model__WEBPACK_IMPORTED_MODULE_0__/* .state.menu */ .SB.menu);
}

function init() {
  controlHomepage();

  _homepageView__WEBPACK_IMPORTED_MODULE_1__/* ["default"].addHandlerRenderMenu */ .Z.addHandlerRenderMenu(controlMenu);
  _menuView__WEBPACK_IMPORTED_MODULE_2__/* ["default"].addHandlerRenderSubcategoriesAndDrinks */ .Z.addHandlerRenderSubcategoriesAndDrinks(controlMenu);
  _menuView__WEBPACK_IMPORTED_MODULE_2__/* ["default"].addHandlerReturnToStreet */ .Z.addHandlerReturnToStreet(controlHomepage);
}
...
/* harmony export */   "pt": () => (/* binding */ preloadImage),
/* harmony export */   "s8": () => (/* binding */ importAll)
/* harmony export */ });
function importAll(obj, requireFunction) {
...
/* harmony export */ });
/* harmony import */ var _assets_images_bar_entrance_closed_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(263);
/* harmony import */ var _assets_images_bar_entrance_opened_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(389);
/* harmony import */ var _View__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(179);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(914);
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(453);
...
await (0,_helper__WEBPACK_IMPORTED_MODULE_2__/* .preloadImage */ .pt)(_assets_images_bar_entrance_opened_png__WEBPACK_IMPORTED_MODULE_1__);

class homepageView extends _View__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z {
  constructor() {
    super();
  ...
  addHandlerRenderMenu(handler) {
    this._parentElement.addEventListener('click', function (e) {
      ...
      }, (_config__WEBPACK_IMPORTED_MODULE_4__/* .MENU_TRANSITION_SEC */ .B + 0.5) * 1000);

      setTimeout(() => {
        document.querySelector('.exit').disabled = false;
      }, (_config__WEBPACK_IMPORTED_MODULE_4__/* .MENU_TRANSITION_SEC */ .B + 0.5) * 2000);
    });
  }
  ...
  addHandlerToggleEntrance() {
    ...
    const toggleEntrance = function (e) {
      streetView.setAttribute(
        'xlink:href',
        e.type === 'mouseenter' ? _assets_images_bar_entrance_opened_png__WEBPACK_IMPORTED_MODULE_1__ : _assets_images_bar_entrance_closed_png__WEBPACK_IMPORTED_MODULE_0__
      );
    };
    ...
    return `
      ...
      >
        ...
        class="bar-img"
          width="1340"
          height="601"
          xlink:href="${_assets_images_bar_entrance_closed_png__WEBPACK_IMPORTED_MODULE_0__}"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new homepageView());
...
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ js_menuView)
});

// EXTERNAL MODULE: ./src/js/View.js
var View = __webpack_require__(179);
// EXTERNAL MODULE: ./src/js/helper.js
var helper = __webpack_require__(453);
;// CONCATENATED MODULE: ./src/assets/images/BTC_icon.jpg
const BTC_icon_namespaceObject = __webpack_require__.p + "a0135725e70581dd222c.jpg";
;// CONCATENATED MODULE: ./src/js/menuView.js




class menuView extends View/* default */.Z {
  _data;
    ...
    return `
      <div class="menu__interface">
        <div class="menu__welcome-window ${
          ...
          <img src="${BTC_icon_namespaceObject}" alt="BTC recipe book">
          <div>
        ...
        <div class="menu__main-frame">
          ...
          <p class="menu__search-by ${
            ...
            <span>Search by:</span>
            <span>
              ${(0,helper/* capitalizeFirstLetter */.fm)(this._data.currentCategory)}
            </span>
          </p>
      ...
      .map(sub => {
        return `
          <li>
            ...
            ${(0,helper/* capitalizeFirstLetter */.fm)(sub)}
...
/* harmony default export */ const js_menuView = (new menuView());
...
/* harmony export */   "dO": () => (/* binding */ setCurrentSubcategory),
/* harmony export */   "wn": () => (/* binding */ setCurrentCategory)
/* harmony export */ });
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(453);


// IMPORTING ASSETS
const _drinksImgs = {};
const _drinksImgsContext = __webpack_require__(366);
(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .importAll */ .s8)(_drinksImgs, _drinksImgsContext);

const _staffImgs = {};
const _staffImgsContext = __webpack_require__(55);
(0,_helper__WEBPACK_IMPORTED_MODULE_0__/* .importAll */ .s8)(_staffImgs, _staffImgsContext);
...
"use strict";
module.exports = __webpack_require__.p + "7938203549089c9518be.png";
...
"use strict";
module.exports = __webpack_require__.p + "138f886c37a7758ade66.png";
...
"use strict";
module.exports = __webpack_require__.p + "a07a95dfa49aeb623ba9.png";
...
"use strict";
module.exports = __webpack_require__.p + "909485c6f049d73b7bc7.png";
...
"use strict";
module.exports = __webpack_require__.p + "cef68b5885303e19c874.png";
...
"use strict";
module.exports = __webpack_require__.p + "5a9a3b4380e6ef518a02.png";
...
"use strict";
module.exports = __webpack_require__.p + "d983f1eb77189a4bbf4a.png";
...
"use strict";
module.exports = __webpack_require__.p + "028b067cb18cea906863.png";
...
"use strict";
module.exports = __webpack_require__.p + "d837f180f9a541f089f9.png";
...
"use strict";
module.exports = __webpack_require__.p + "ea1488c668f06952dab8.png";
...
"use strict";
module.exports = __webpack_require__.p + "2b5508fb91b337a1561f.png";
...
"use strict";
module.exports = __webpack_require__.p + "322d2224301cd1ddd670.png";
...
"use strict";
module.exports = __webpack_require__.p + "e5187e96c283770a37a7.png";
...
"use strict";
module.exports = __webpack_require__.p + "7ff12914cb3c06dbfb51.png";
...
"use strict";
module.exports = __webpack_require__.p + "2e7bca3c93f9c93e2882.png";
...
"use strict";
module.exports = __webpack_require__.p + "3857e815e57b80704ca3.png";
...
"use strict";
module.exports = __webpack_require__.p + "58f7a832349382a5bf4f.png";
...
"use strict";
module.exports = __webpack_require__.p + "0f82a3756db340ac82cb.png";
...
"use strict";
module.exports = __webpack_require__.p + "51c0956c2c920c93ad9e.png";
...
"use strict";
module.exports = __webpack_require__.p + "be760962326b8250d364.png";
...
"use strict";
module.exports = __webpack_require__.p + "ab649efc59f693ba3575.png";
...
"use strict";
module.exports = __webpack_require__.p + "6926988d742c221adb8c.png";
...
"use strict";
module.exports = __webpack_require__.p + "dec764ef3fac8a218625.png";
...
"use strict";
module.exports = __webpack_require__.p + "71636192950b12a66c44.png";
...
"use strict";
module.exports = __webpack_require__.p + "6f5190a33e2a457e98ee.png";
...
"use strict";
module.exports = __webpack_require__.p + "dd832c46933a15adca83.webp";
...
"use strict";
module.exports = __webpack_require__.p + "4c499028ad667f7a5132.webp";
...
"use strict";
module.exports = __webpack_require__.p + "d6beff230cbe6a3e1b27.webp";
...
/******/ 	var __webpack_exports__ = __webpack_require__(566);
/******/ 	
/******/ })()
;